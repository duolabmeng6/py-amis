...
class InputGroupControl(AmisComponent):
    def __init__(self):
        super().__init__()
        self.set("type", "input-group-control")
    ...
    def validationConfig(self, validationConfig):
        # 校验提示信息配置
        
        return self.set("validationConfig", validationConfig)
