...
class IFrame(AmisComponent):
    def __init__(self):
        super().__init__()
        self.set("type", "i-frame")
    ...
    def referrerpolicy(self, referrerpolicy):
        # 可选项: ['no-referrer', 'no-referrer-when-downgrade', 'origin', 'origin-when-cross-origin', 'same-origin', 'strict-origin', 'strict-origin-when-cross-origin', 'unsafe-url']
        
        return self.set("referrerpolicy", referrerpolicy)

        
    def sandbox(self, sandbox):
        
        
        return self.set("sandbox", sandbox)
