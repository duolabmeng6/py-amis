...
class BaseApiObject(AmisComponent):
    def __init__(self):
        super().__init__()
        self.set("type", "base-api-object")
    ...
    def concatDataFields(self, concatDataFields):
        ...
        return self.set("concatDataFields", concatDataFields)
