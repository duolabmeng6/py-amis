...
class Steps(AmisComponent):
    ...
    def mode(self, mode):
        # 展示模式# 可选项: ['horizontal', 'vertical']
        
        return self.set("mode", mode)

        
    def labelPlacement(self, labelPlacement):
        # 标签放置位置# 可选项: ['horizontal', 'vertical']
        
        return self.set("labelPlacement", labelPlacement)

        
    def progressDot(self, progressDot):
        # 点状步骤条
        
        return self.set("progressDot", progressDot)
