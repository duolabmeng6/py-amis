...
class Calendar(AmisComponent):
    def __init__(self):
        super().__init__()
        self.set("type", "calendar")
    ...
    def schedules(self, schedules):
        ...
        return self.set("schedules", schedules)

        
    def scheduleClassNames(self, scheduleClassNames):
        # 日程显示颜色自定义
        
        return self.set("scheduleClassNames", scheduleClassNames)

        
    def scheduleAction(self, scheduleAction):
        # 日程点击展示
        
        return self.set("scheduleAction", scheduleAction)

        
    def largeMode(self, largeMode):
        # 是否开启放大模式
        
        return self.set("largeMode", largeMode)

        
    def todayActiveStyle(self, todayActiveStyle):
        # 今日激活时的自定义样式
        
        return self.set("todayActiveStyle", todayActiveStyle)
