...
class Tag(AmisComponent):
    ...
    def displayMode(self, displayMode):
        # normal: 面性标签，对应color的背景色 rounded: 线性标签， 对应color的边框 status: 带图标的标签， 图标可以自定义# 可选项: ['normal', 'rounded', 'status']
    ...
    def closeIcon(self, closeIcon):
        # 关闭图标
        # iconfont 里面的类名。
        return self.set("closeIcon", closeIcon)

        
    def checkable(self, checkable):
        # 是否是可选的标签
        
        return self.set("checkable", checkable)
