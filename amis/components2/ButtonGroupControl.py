...
class ButtonGroupControl(AmisComponent):
    def __init__(self):
        super().__init__()
        self.set("type", "button-group-control")
    ...
    def btnActiveClassName(self, btnActiveClassName):
        
        
        return self.set("btnActiveClassName", btnActiveClassName)
