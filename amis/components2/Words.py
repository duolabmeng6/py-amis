...
class Words(AmisComponent):
    ...
    def expendButtonText(self, expendButtonText):
        # 展示文字
        
        return self.set("expendButtonText", expendButtonText)

        
    def expendButton(self, expendButton):
        # 展示文字
        
        return self.set("expendButton", expendButton)

        
    def collapseButtonText(self, collapseButtonText):
        # 收起文字
        
        return self.set("collapseButtonText", collapseButtonText)

        
    def collapseButton(self, collapseButton):
        # 展示文字
        
        return self.set("collapseButton", collapseButton)

        
    def words(self, words):
        # tags数据
        
        return self.set("words", words)

        
    def inTag(self, inTag):
        # useTag 当数据是数组时，是否使用tag的方式展示
        
        return self.set("inTag", inTag)
