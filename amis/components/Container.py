...
class Container(AmisComponent):
    ...
    def wrapperBody(self, wrapperBody):
        # 是否需要对body加一层div包裹，默认为 true
        
        return self.set("wrapperBody", wrapperBody)
    ...
    def draggableConfig(self, draggableConfig):
        # 是否开启容器拖拽配置
        
        return self.set("draggableConfig", draggableConfig)
