...
class ListControl(AmisComponent):
    def __init__(self):
        super().__init__()
        self.set("type", "list-control")
    ...
    def submitOnDBClick(self, submitOnDBClick):
        # 开启双击点选并提交。
        
        return self.set("submitOnDBClick", submitOnDBClick)
    ...
    def activeItemSchema(self, activeItemSchema):
        # 激活态自定义展示模板。
        
        return self.set("activeItemSchema", activeItemSchema)
