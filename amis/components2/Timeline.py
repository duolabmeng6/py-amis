...
class Timeline(AmisComponent):
    def __init__(self):
        super().__init__()
        self.set("type", "timeline")
    ...
    def mode(self, mode):
        # 文字相对于时间轴展示方向# 可选项: ['left', 'right', 'alternate']
        
        return self.set("mode", mode)

        
    def direction(self, direction):
        # 展示方向# 可选项: ['horizontal', 'vertical']
    ...
    def itemTitleSchema(self, itemTitleSchema):
        # 节点title自定一展示模板
        
        return self.set("itemTitleSchema", itemTitleSchema)
