...
class LocationControl(AmisComponent):
    def __init__(self):
        super().__init__()
        self.set("type", "location-control")
    ...
    def getLocationPlaceholder(self, getLocationPlaceholder):
        # 开启只读模式后的占位提示，默认为“点击获取位置信息” 备注：区分下现有的placeholder（“请选择位置”）
        
        return self.set("getLocationPlaceholder", getLocationPlaceholder)
