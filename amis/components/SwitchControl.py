...
class SwitchControl(AmisComponent):
    def __init__(self):
        super().__init__()
        self.set("type", "switch-control")
    ...
    def onText(self, onText):
        # 开启时显示的内容
        
        return self.set("onText", onText)

        
    def offText(self, offText):
        # 关闭时显示的内容
        
        return self.set("offText", offText)
