...
class AjaxAction(AmisComponent):
    def __init__(self):
        super().__init__()
        self.set("type", "ajax-action")
    ...
    def ignoreConfirm(self, ignoreConfirm):
        
        
        return self.set("ignoreConfirm", ignoreConfirm)

        
    def isolateScope(self, isolateScope):
        # 是否开启请求隔离, 主要用于隔离联动CRUD, Service的请求
        
        return self.set("isolateScope", isolateScope)
