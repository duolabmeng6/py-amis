...
class TextControl(AmisComponent):
    def __init__(self):
        super().__init__()
        self.set("type", "text-control")
    ...
    def type(self, type):
        # 表单项类型# 可选项: ['input-text', 'input-email', 'input-url', 'input-password', 'native-date', 'native-time', 'native-number']
