...
class Color(AmisComponent):
    ...
    def defaultColor(self, defaultColor):
        # 默认颜色
        
        return self.set("defaultColor", defaultColor)

        
    def showValue(self, showValue):
        # 是否用文字显示值。
        
        return self.set("showValue", showValue)
