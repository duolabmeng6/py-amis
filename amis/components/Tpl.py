...
class Tpl(AmisComponent):
    ...
    def type(self, type):
        # 指定为模板渲染器。  文档：https://aisuda.bce.baidu.com/amis/zh-CN/docs/concepts/template# 可选项: ['tpl', 'html']
