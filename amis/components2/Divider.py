...
class Divider(AmisComponent):
    ...
    def lineStyle(self, lineStyle):
        ...
        return self.set("lineStyle", lineStyle)

        
    def direction(self, direction):
        # 可选项: ['horizontal', 'vertical']
    ...
    def titlePosition(self, titlePosition):
        # 可选项: ['left', 'center', 'right']
        
        return self.set("titlePosition", titlePosition)
