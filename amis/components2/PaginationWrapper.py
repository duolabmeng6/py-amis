...
class PaginationWrapper(AmisComponent):
    def __init__(self):
        super().__init__()
        self.set("type", "pagination-wrapper")
    ...
    def inputName(self, inputName):
        ...
        return self.set("inputName", inputName)

        
    def outputName(self, outputName):
        # 输出字段名
        
        return self.set("outputName", outputName)
    ...
    def position(self, position):
        # 分页显示位置，如果配置为 none 则需要自己在内容区域配置 pagination 组件，否则不显示。# 可选项: ['top', 'bottom', 'none']
