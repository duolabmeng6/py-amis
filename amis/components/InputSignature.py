...
class InputSignature(AmisComponent):
    def __init__(self):
        super().__init__()
        self.set("type", "input-signature")
    ...
    def bgColor(self, bgColor):
        ...
        return self.set("bgColor", bgColor)

        
    def clearBtnLabel(self, clearBtnLabel):
        # 清空按钮名称
        
        return self.set("clearBtnLabel", clearBtnLabel)

        
    def clearBtnIcon(self, clearBtnIcon):
        # 清空按钮图标
        
        return self.set("clearBtnIcon", clearBtnIcon)

        
    def undoBtnLabel(self, undoBtnLabel):
        # 撤销按钮名称
        
        return self.set("undoBtnLabel", undoBtnLabel)

        
    def undoBtnIcon(self, undoBtnIcon):
        # 清空按钮图标
        
        return self.set("undoBtnIcon", undoBtnIcon)
    ...
    def embedConfirmLabel(self, embedConfirmLabel):
        # 弹窗确认按钮名称
        
        return self.set("embedConfirmLabel", embedConfirmLabel)

        
    def embedConfirmIcon(self, embedConfirmIcon):
        # 弹窗确认按钮图标
        
        return self.set("embedConfirmIcon", embedConfirmIcon)

        
    def ebmedCancelLabel(self, ebmedCancelLabel):
        # 弹窗取消按钮名称
        
        return self.set("ebmedCancelLabel", ebmedCancelLabel)

        
    def ebmedCancelIcon(self, ebmedCancelIcon):
        # 弹窗取消按钮图标
        
        return self.set("ebmedCancelIcon", ebmedCancelIcon)

        
    def embedBtnIcon(self, embedBtnIcon):
        # 弹窗按钮图标
        
        return self.set("embedBtnIcon", embedBtnIcon)

        
    def embedBtnLabel(self, embedBtnLabel):
        # 弹窗按钮文案
        
        return self.set("embedBtnLabel", embedBtnLabel)
