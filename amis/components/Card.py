...
class Card(AmisComponent):
    ...
    def secondary(self, secondary):
        ...
        return self.set("secondary", secondary)

        
    def useCardLabel(self, useCardLabel):
        # 卡片内容区的表单项label是否使用Card内部的样式，默认为true
        
        return self.set("useCardLabel", useCardLabel)
