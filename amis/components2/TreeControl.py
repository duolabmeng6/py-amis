...
class TreeControl(AmisComponent):
    def __init__(self):
        super().__init__()
        self.set("type", "tree-control")
    ...
    def rootValue(self, rootValue):
        # 顶级选项的值
        
        return self.set("rootValue", rootValue)
    ...
    def enableDefaultIcon(self, enableDefaultIcon):
        # 是否为选项添加默认的Icon，默认值为true
        
        return self.set("enableDefaultIcon", enableDefaultIcon)
    ...
    def heightAuto(self, heightAuto):
        # 高度自动增长？
        
        return self.set("heightAuto", heightAuto)
