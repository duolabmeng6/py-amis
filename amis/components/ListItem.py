...
class ListItem(AmisComponent):
    def __init__(self):
        super().__init__()
        self.set("type", "list-item")
    ...
    def actionsPosition(self, actionsPosition):
        # 操作位置，默认在右侧，可以设置成左侧。# 可选项: ['left', 'right']
        
        return self.set("actionsPosition", actionsPosition)
